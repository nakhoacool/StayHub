        ...
        <div>
          <form>
            ...
            <p className='text-gray-500 text-sm'>
              Give your place a title that stands out
            </p>
            <input type='text' placeholder='My lovely house' />
            <h2 className='text-2xl mt-4'>Address</h2>
            <p className='text-gray-500 text-sm'>
              Enter the address for your place
            </p>
            ...
            <textarea placeholder='Describe your place to guests' />
            <h2 className='text-2xl mt-4'>Perks</h2>
            <p className='text-gray-500 text-sm'>
              Select all that apply to your place
            </p>
            ...
            <textarea placeholder='Add any extra info that guests should know' />
